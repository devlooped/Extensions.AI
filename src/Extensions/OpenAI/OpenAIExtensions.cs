...
/// <summary>Provides OpenAI-specific extension properties for <see cref="ChatOptions"/> when using the OpenAI Responses API.</summary>
[EditorBrowsable(EditorBrowsableState.Never)]
public static class OpenAIExtensions
{
    /// <summary>Gets or sets the effort level for a reasoning AI model when generating responses.</summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <exception cref="InvalidOperationException">Thrown when <see cref="ChatOptions.RawRepresentationFactory"/> has been set to a non-OpenAI factory.</exception>
    extension(ChatOptions options)
    {
        /// <summary>Gets or sets the <see cref="AI.Verbosity"/> level for a GPT-5 model when generating responses.</summary>
        /// <remarks>
